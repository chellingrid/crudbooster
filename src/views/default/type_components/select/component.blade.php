<?php $default = ! empty($form['default']) ? $form['default'] : cbLang('text_prefix_option')." ".cbLang($form['label']);?>
        ...
        <script type="text/javascript">
            $(function () {
                $('#{{$parent}}, input:radio[name={{$parent}}]').change(function () {
                    ...
                    if (fk_value != '') {
                        $current.html("<option value=''>{{cbLang('text_loading')}} {{cbLang($form['label'])}}");
